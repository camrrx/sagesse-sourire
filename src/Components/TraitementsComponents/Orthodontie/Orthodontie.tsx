						...
						<Tab.Panel className="custom-tab-panel">
							<div>
								...
								<h5>
									...
									et de la tête au complet.
								</h5>
								<h6>
									En moyenne, un traitement orthodontique complet peut durer de
									1 à 3 ans. Les patients doivent porter après la fin du
									traitement un mainteneur d’espace pendant au moins 6 mois.
									Suite aux ajustements fait durant le traitement d'orthodontie,
									un inconfort ou une douleur peut être sentie au niveau des
									dents et de la bouche. Si une douleur persiste il faut en
									parler à l'orthodontiste. Le processus mécanique est le même à
									n'importe quel âge. Pour votre cas, notre équipe s’engage à
									vous informer sur les avantages et les inconvénients éventuels
									des traitements à réalisés et sur leurs coûts.
								</h6>
								<div className="orthodontie-video"> insérer video</div>
							</div>
						</Tab.Panel>
						<Tab.Panel className="custom-tab-panel">
							<div>
