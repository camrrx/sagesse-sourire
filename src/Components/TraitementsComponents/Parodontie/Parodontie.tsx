						...
						<Tab.Panel className="custom-tab-panel">
							<div>
								...
								<div>
									...
									<h6>
										Le traitement sert à enlever les zones tissulaires abimées
										"carie", et à obturer la cavité avec différents matériaux
										pour favoriser la cicatrisation des tissus sains, afin
										d'éviter la récidive. Les matériaux utilisés sont
										l'amalgamme "plombage" , les composites ou les onlays.
									</h6>
								</div>
								<div>
									<h2>L' ENDODONTIE</h2>
									<h6>
										C'est le traitement des pathologies de la pulpe. La pulpe
										est située au milieu de la couronne dentaire. Lorsqu’elle
										est atteinte par la carie, elle ne peut pas être conservée
										vivante dans la plupart des cas
									</h6>
								</div>
							</div>
						</Tab.Panel>
						<Tab.Panel className="custom-tab-panel">
							<div className="-container">
								<h5>
									...
									important de faire des contr�les reguliers. Notre équipe vous
								...
								<div>
									<h2>LE DETARTRAGE</h2>
									<h6>
										Cela débute par l’apprentissage d'une hygiène bucco-dentaire
										rigoureuse. Le traitement consiste à éliminer les causes
										(tartre et plaque) pour assainir le terrain
									</h6>
								</div>
								<div>
									...
									<h6>
										...
										gencive, ou à la gencive et à l'os alvéolaire pour supprimer
										les poches osseuses, éliminer les bactéries dans les lésions
										profondes, redonner à la gencive une forme fonctionnelle.
										Ces traitements ne sont pas pris en charge par la sécurité
										sociale, nous vous établirons un devis préalable en fonction
										de votre cas.
									</h6>
								</div>
								<div>
						...
						<Tab.Panel className="custom-tab-panel">
							<div className="-container">
								...
								<div>
									<h2>LE BRUXISME</h2>
									<h6>
										Le bruxisme est souvent dû à une occlusion anormale ou à une
										souffrance psychologique, stress Le bruxisme ou grincement
										des dents correspond à une augmentation importante des
										périodes de contact des dents entre elles en dehors de la
										mastication et de déglutition. Le bruxisme peut être
										effectué le jour et la nuit pendant le sommeil. Les
										mouvements sont inconsciemment, ce qui entra�ne des
								...
								<div>
									...
									<h6>
										...
										l'organisme ou des aliments). Les facteurs qui favorisent la
										mauvaise haleine ; Prévenir la mauvaise haleine ;
										Traitements.
									</h6>
								</div>
								<div>
