...
const GestionDouleurs = () => {
	...
	return (
		<div className="GestionDouleurs-container grey-theme">
						...
						<Tab.Panel className="custom-tab-panel">
							<div>
								<h5>
									...
									<h6>
										-Pour que l’anesthésie soit indolore, il est nécessaire dans
										un premier temps d’anesthésier la muqueuse au niveau de la
										papille interdentaire. L’injection est gérée
										électroniquement.
									</h6>
									<h6>
										...
										pénétration en ostéocentrale est totalement indolore pour le
										patient.
									</h6>
									<h6>
										- Une fois l’aiguille enfoncée au trois quarts de sa
										longueur, nous sommes proche du bout de la racine et pouvons
										déclencher l’injection électroniquement. Lorsque l’injection
										est terminée, nous retirons l’aiguille sans rotation.
										L’anesthésie est faite et le soin peut commencer.
									</h6>
								</h5>
							</div>
						</Tab.Panel>
